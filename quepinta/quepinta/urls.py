...
from .views import EventListView, EventCreateView, reservar_evento  # Import the register, EventListView, EventCreateView, and reservar_evento views
...
urlpatterns = [
    ...
    path('crear-evento/', EventCreateView.as_view(), name='crear_evento'),
